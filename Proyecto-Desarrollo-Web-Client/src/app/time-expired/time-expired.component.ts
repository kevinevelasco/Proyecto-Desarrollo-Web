...
@Component({
  selector: 'app-time-expired',
  templateUrl: './time-expired.component.html',
  styleUrl: './time-expired.component.css'
})
export class TimeExpiredComponent implements OnInit, OnDestroy {
  ...
  constructor(public dialogRef: MatDialogRef<TimeExpiredComponent>, private loginService: LoginService, private playerService: PlayerService,
