        ...
        for (int i = 0; i < 40000; i++) {
            ...
            if (i <= 400) {
                ...
                if (random == 1) {
                    ...
                    planet1.setCharacter(faker.number().numberBetween(1, 10));
                    ...
                    planet1.setCharacter(faker.number().numberBetween(1, 5));
                    ...
                    planet2.setCharacter(faker.number().numberBetween(6, 10));
                    ...
                    planet2.setCharacter(faker.number().numberBetween(5, 8));
                    ...
                    planet3.setCharacter(faker.number().numberBetween(9, 10));
